...
/**
 * The getSupportChangeRequest options.
 */
public class GetSupportChangeRequestOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetSupportChangeRequestOptions getSupportChangeRequestOptions) {
      this.productId = getSupportChangeRequestOptions.productId;
      this.changeRequestId = getSupportChangeRequestOptions.changeRequestId;
    }
    ...
    /**
     * Builds a GetSupportChangeRequestOptions.
     *
     * @return the new GetSupportChangeRequestOptions instance
     */
    public GetSupportChangeRequestOptions build() {
      return new GetSupportChangeRequestOptions(this);
    }
     ...
     *
     * @param productId the productId
     * @return the GetSupportChangeRequestOptions builder
     */
  ...
  protected GetSupportChangeRequestOptions() { }

  protected GetSupportChangeRequestOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetSupportChangeRequestOptions builder
   */
