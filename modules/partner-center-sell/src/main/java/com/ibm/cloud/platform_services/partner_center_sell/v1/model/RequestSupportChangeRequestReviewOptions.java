...
/**
 * The requestSupportChangeRequestReview options.
 */
public class RequestSupportChangeRequestReviewOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(RequestSupportChangeRequestReviewOptions requestSupportChangeRequestReviewOptions) {
      this.productId = requestSupportChangeRequestReviewOptions.productId;
      this.changeRequestId = requestSupportChangeRequestReviewOptions.changeRequestId;
    }
    ...
    /**
     * Builds a RequestSupportChangeRequestReviewOptions.
     *
     * @return the new RequestSupportChangeRequestReviewOptions instance
     */
    public RequestSupportChangeRequestReviewOptions build() {
      return new RequestSupportChangeRequestReviewOptions(this);
    }
     ...
     *
     * @param productId the productId
     * @return the RequestSupportChangeRequestReviewOptions builder
     */
  ...
  protected RequestSupportChangeRequestReviewOptions() { }

  protected RequestSupportChangeRequestReviewOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a RequestSupportChangeRequestReviewOptions builder
   */
