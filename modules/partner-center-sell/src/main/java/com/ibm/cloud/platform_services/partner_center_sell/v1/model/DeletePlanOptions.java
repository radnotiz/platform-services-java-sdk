...
/**
 * The deletePlan options.
 */
public class DeletePlanOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(DeletePlanOptions deletePlanOptions) {
      this.productId = deletePlanOptions.productId;
      this.pricingPlanId = deletePlanOptions.pricingPlanId;
    }
    ...
    /**
     * Builds a DeletePlanOptions.
     *
     * @return the new DeletePlanOptions instance
     */
    public DeletePlanOptions build() {
      return new DeletePlanOptions(this);
    }
     ...
     *
     * @param productId the productId
     * @return the DeletePlanOptions builder
     */
  ...
  protected DeletePlanOptions() { }

  protected DeletePlanOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a DeletePlanOptions builder
   */
