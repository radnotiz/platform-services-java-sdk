...
/**
 * The mergeSupportChangeRequest options.
 */
public class MergeSupportChangeRequestOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(MergeSupportChangeRequestOptions mergeSupportChangeRequestOptions) {
      this.productId = mergeSupportChangeRequestOptions.productId;
      this.changeRequestId = mergeSupportChangeRequestOptions.changeRequestId;
    }
    ...
    /**
     * Builds a MergeSupportChangeRequestOptions.
     *
     * @return the new MergeSupportChangeRequestOptions instance
     */
    public MergeSupportChangeRequestOptions build() {
      return new MergeSupportChangeRequestOptions(this);
    }
     ...
     *
     * @param productId the productId
     * @return the MergeSupportChangeRequestOptions builder
     */
  ...
  protected MergeSupportChangeRequestOptions() { }

  protected MergeSupportChangeRequestOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a MergeSupportChangeRequestOptions builder
   */
