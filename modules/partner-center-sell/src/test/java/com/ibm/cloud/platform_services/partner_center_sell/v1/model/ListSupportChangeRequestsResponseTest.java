...
/**
 * Unit test class for the ListSupportChangeRequestsResponse model.
 */
public class ListSupportChangeRequestsResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListSupportChangeRequestsResponse() throws Throwable {
    ListSupportChangeRequestsResponse listSupportChangeRequestsResponseModel = new ListSupportChangeRequestsResponse();
    assertNull(listSupportChangeRequestsResponseModel.getChanges());
  }
}