...
/**
 * Unit test class for the ListBadgesOptions model.
 */
public class ListBadgesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListBadgesOptions() throws Throwable {
    ListBadgesOptions listBadgesOptionsModel = new ListBadgesOptions();
    assertNotNull(listBadgesOptionsModel);
  }
}