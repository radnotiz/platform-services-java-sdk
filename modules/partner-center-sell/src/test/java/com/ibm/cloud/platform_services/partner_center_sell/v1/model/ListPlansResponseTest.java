...
/**
 * Unit test class for the ListPlansResponse model.
 */
public class ListPlansResponseTest {
  ...
  @Test
  public void testListPlansResponse() throws Throwable {
    ListPlansResponse listPlansResponseModel = new ListPlansResponse();
    assertNull(listPlansResponseModel.getPlans());
  }
}