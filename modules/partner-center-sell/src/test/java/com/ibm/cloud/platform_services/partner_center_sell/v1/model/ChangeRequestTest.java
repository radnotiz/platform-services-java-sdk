...
/**
 * Unit test class for the ChangeRequest model.
 */
public class ChangeRequestTest {
  ...
  public void testChangeRequest() throws Throwable {
    ChangeRequest changeRequestModel = new ChangeRequest();
    assertNull(changeRequestModel.getId());
    assertNull(changeRequestModel.getCreatedAt());
    assertNull(changeRequestModel.getInitiator());
    assertNull(changeRequestModel.getMerged());
    assertNull(changeRequestModel.getChange());
  }
}