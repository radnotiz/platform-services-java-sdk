...
/**
 * Unit test class for the ListProductApprovalsOptions model.
 */
public class ListProductApprovalsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListProductApprovalsOptions() throws Throwable {
    ListProductApprovalsOptions listProductApprovalsOptionsModel = new ListProductApprovalsOptions.Builder()
      ...
      .build();
    assertEquals(listProductApprovalsOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testListProductApprovalsOptionsError() throws Throwable {
    new ListProductApprovalsOptions.Builder().build();
  }
