...
/**
 * Unit test class for the ListSupportChangeRequestsOptions model.
 */
public class ListSupportChangeRequestsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListSupportChangeRequestsOptions() throws Throwable {
    ListSupportChangeRequestsOptions listSupportChangeRequestsOptionsModel = new ListSupportChangeRequestsOptions.Builder()
      ...
      .build();
    assertEquals(listSupportChangeRequestsOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testListSupportChangeRequestsOptionsError() throws Throwable {
    new ListSupportChangeRequestsOptions.Builder().build();
  }
