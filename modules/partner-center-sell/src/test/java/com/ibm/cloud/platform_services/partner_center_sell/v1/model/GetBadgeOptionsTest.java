...
/**
 * Unit test class for the GetBadgeOptions model.
 */
public class GetBadgeOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetBadgeOptions() throws Throwable {
    GetBadgeOptions getBadgeOptionsModel = new GetBadgeOptions.Builder()
      .badgeId("9fab83da-98cb-4f18-a7ba-b6f0435c9673")
      .build();
    assertEquals(getBadgeOptionsModel.badgeId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetBadgeOptionsError() throws Throwable {
    new GetBadgeOptions.Builder().build();
  }
