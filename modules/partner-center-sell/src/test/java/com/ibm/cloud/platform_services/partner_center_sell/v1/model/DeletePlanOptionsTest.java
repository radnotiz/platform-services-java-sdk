...
/**
 * Unit test class for the DeletePlanOptions model.
 */
public class DeletePlanOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeletePlanOptions() throws Throwable {
    DeletePlanOptions deletePlanOptionsModel = new DeletePlanOptions.Builder()
      ...
      .build();
    assertEquals(deletePlanOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
    assertEquals(deletePlanOptionsModel.pricingPlanId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeletePlanOptionsError() throws Throwable {
    new DeletePlanOptions.Builder().build();
  }
