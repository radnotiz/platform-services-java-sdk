...
/**
 * Unit test class for the ListPlansOptions model.
 */
public class ListPlansOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListPlansOptions() throws Throwable {
    ListPlansOptions listPlansOptionsModel = new ListPlansOptions.Builder()
      .productId("9fab83da-98cb-4f18-a7ba-b6f0435c9673")
      .build();
    assertEquals(listPlansOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testListPlansOptionsError() throws Throwable {
    new ListPlansOptions.Builder().build();
  }
