...
/**
 * Unit test class for the RequestCatalogApprovalOptions model.
 */
public class RequestCatalogApprovalOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRequestCatalogApprovalOptions() throws Throwable {
    RequestCatalogApprovalOptions requestCatalogApprovalOptionsModel = new RequestCatalogApprovalOptions.Builder()
      ...
      .build();
    assertEquals(requestCatalogApprovalOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRequestCatalogApprovalOptionsError() throws Throwable {
    new RequestCatalogApprovalOptions.Builder().build();
  }
