...
/**
 * Unit test class for the GetSupportOptions model.
 */
public class GetSupportOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSupportOptions() throws Throwable {
    GetSupportOptions getSupportOptionsModel = new GetSupportOptions.Builder()
      .productId("9fab83da-98cb-4f18-a7ba-b6f0435c9673")
      .build();
    assertEquals(getSupportOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetSupportOptionsError() throws Throwable {
    new GetSupportOptions.Builder().build();
  }
