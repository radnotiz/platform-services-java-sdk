...
/**
 * Unit test class for the Support model.
 */
public class SupportTest {
  ...
  public void testSupport() throws Throwable {
    ...
    String json = TestUtilities.serialize(supportModel);

    Support supportModelNew = TestUtilities.deserialize(json, Support.class);
    assertTrue(supportModelNew instanceof Support);
    assertEquals(supportModelNew.process(), "testString");
    assertEquals(supportModelNew.processI18n().toString(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } }.toString());
    assertEquals(supportModelNew.supportEscalation().toString(), supportEscalationModel.toString());
    assertEquals(supportModelNew.supportType(), "third-party");
    assertEquals(supportModelNew.url(), "https://my-company.com/support");
  }
}