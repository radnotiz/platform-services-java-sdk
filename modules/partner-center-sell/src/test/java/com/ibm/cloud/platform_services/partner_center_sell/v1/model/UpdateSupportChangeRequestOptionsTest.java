...
/**
 * Unit test class for the UpdateSupportChangeRequestOptions model.
 */
public class UpdateSupportChangeRequestOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateSupportChangeRequestOptions() throws Throwable {
    ...
    UpdateSupportChangeRequestOptions updateSupportChangeRequestOptionsModel = new UpdateSupportChangeRequestOptions.Builder()
      ...
      .change(supportModel)
      .build();
    assertEquals(updateSupportChangeRequestOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
    assertEquals(updateSupportChangeRequestOptionsModel.changeRequestId(), "testString");
    assertEquals(updateSupportChangeRequestOptionsModel.change(), supportModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateSupportChangeRequestOptionsError() throws Throwable {
    new UpdateSupportChangeRequestOptions.Builder().build();
  }
