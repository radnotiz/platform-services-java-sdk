...
/**
 * Unit test class for the DeleteProductOptions model.
 */
public class DeleteProductOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteProductOptions() throws Throwable {
    DeleteProductOptions deleteProductOptionsModel = new DeleteProductOptions.Builder()
      ...
      .build();
    assertEquals(deleteProductOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteProductOptionsError() throws Throwable {
    new DeleteProductOptions.Builder().build();
  }
