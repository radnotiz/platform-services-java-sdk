...
public class LicenseTest {
  ...
  public void testLicense() throws Throwable {
    License licenseModel = new License();
    assertNull(licenseModel.getDescription());
    assertNull(licenseModel.getId());
    assertNull(licenseModel.getLabel());
    assertNull(licenseModel.getType());
    assertNull(licenseModel.getUrl());
  }
}