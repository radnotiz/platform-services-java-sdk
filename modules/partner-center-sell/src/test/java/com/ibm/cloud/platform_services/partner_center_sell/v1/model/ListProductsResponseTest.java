...
/**
 * Unit test class for the ListProductsResponse model.
 */
public class ListProductsResponseTest {
  ...
  @Test
  public void testListProductsResponse() throws Throwable {
    ListProductsResponse listProductsResponseModel = new ListProductsResponse();
    assertNull(listProductsResponseModel.getErrors());
    assertNull(listProductsResponseModel.getProducts());
  }
}