...
/**
 * Unit test class for the GetProductOptions model.
 */
public class GetProductOptionsTest {
  ...
  @Test
  public void testGetProductOptions() throws Throwable {
    GetProductOptions getProductOptionsModel = new GetProductOptions.Builder()
      .productId("9fab83da-98cb-4f18-a7ba-b6f0435c9673")
      .build();
    assertEquals(getProductOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetProductOptionsError() throws Throwable {
    new GetProductOptions.Builder().build();
  }
