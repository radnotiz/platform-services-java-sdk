...
/**
 * Unit test class for the GetPlanOptions model.
 */
public class GetPlanOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetPlanOptions() throws Throwable {
    GetPlanOptions getPlanOptionsModel = new GetPlanOptions.Builder()
      ...
      .build();
    assertEquals(getPlanOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
    assertEquals(getPlanOptionsModel.pricingPlanId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetPlanOptionsError() throws Throwable {
    new GetPlanOptions.Builder().build();
  }
