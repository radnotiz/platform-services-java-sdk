...
/**
 * Unit test class for the RequestSupportApprovalOptions model.
 */
public class RequestSupportApprovalOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRequestSupportApprovalOptions() throws Throwable {
    RequestSupportApprovalOptions requestSupportApprovalOptionsModel = new RequestSupportApprovalOptions.Builder()
      ...
      .build();
    assertEquals(requestSupportApprovalOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRequestSupportApprovalOptionsError() throws Throwable {
    new RequestSupportApprovalOptions.Builder().build();
  }
