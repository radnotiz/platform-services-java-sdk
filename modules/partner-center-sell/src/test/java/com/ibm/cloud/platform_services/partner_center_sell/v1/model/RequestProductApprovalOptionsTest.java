...
/**
 * Unit test class for the RequestProductApprovalOptions model.
 */
public class RequestProductApprovalOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRequestProductApprovalOptions() throws Throwable {
    RequestProductApprovalOptions requestProductApprovalOptionsModel = new RequestProductApprovalOptions.Builder()
      ...
      .build();
    assertEquals(requestProductApprovalOptionsModel.productId(), "9fab83da-98cb-4f18-a7ba-b6f0435c9673");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRequestProductApprovalOptionsError() throws Throwable {
    new RequestProductApprovalOptions.Builder().build();
  }
