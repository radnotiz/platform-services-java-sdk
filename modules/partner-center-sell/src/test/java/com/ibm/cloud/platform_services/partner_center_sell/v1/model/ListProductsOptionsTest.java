...
/**
 * Unit test class for the ListProductsOptions model.
 */
public class ListProductsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListProductsOptions() throws Throwable {
    ListProductsOptions listProductsOptionsModel = new ListProductsOptions();
    assertNotNull(listProductsOptionsModel);
  }
}